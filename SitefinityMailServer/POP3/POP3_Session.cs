...
using SitefinityMailServer.POP3.IO;
using SitefinityMailServer.POP3.TCP;
using SitefinityMailServer.POP3.AUTH;
using SitefinityMailServer.POP3.Net;

namespace SitefinityMailServer.POP3
{
    /// <summary>
    ...
    public class POP3_Session : TCP_ServerSession
    {
        ...
        public KeyValueCollection<string, POP3_ServerMessage> m_pMessages { get; private set; }
        ...
        private void PASS(string cmdText)
        {
            ...
            */
            ...
            //if(e.IsAuthenticated){
                ...
                this.Server.OnUserAuthenticated(this, new Pop3SessionEventArgs() { });
        ...
        private void RETR(string cmdText)
        {
            ...
            */
            ...
            POP3_ServerMessage msg = null;
            int messageNum = Convert.ToInt32(args[0]) - 1;
            if (m_pMessages.TryGetValueAt(messageNum, out msg))
            {
                // Block messages marked for deletion.
                if(msg.IsMarkedForDeletion){
                    WriteLine("-ERR Invalid operation: Message marked for deletion.");
        ...
        private void QUIT(string cmdText)
        {
            ...
            */
            ...
            try{                
                ...
                this.Server.OnUserQuit(this, new Pop3SessionEventArgs() { });
