...
namespace SitefinityMailServer.SMTP
{
    /// <summary>
    ...
    public class SMTPProcessor
    {
        ...
        // Messages
        private const string MESSAGE_DEFAULT_WELCOME = "220 {0} Welcome Sitefinity's Mail Server.";
        ...
        public delegate void SmtpEventHandler(object sender, MessageEventArgs e);
        public event SmtpEventHandler MessageReceived;
